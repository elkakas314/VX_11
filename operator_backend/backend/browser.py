...
class BrowserClient:
    ...
    def __init__(self, impl: str = None, headless: bool = True, timeout_ms: int = 30000):
        ...
        write_log("operator_backend", f"browser_client:init:{self.impl}:headless={self.headless}:timeout={self.timeout_ms}ms")
    ...
    async def execute_js(self, url: str, script: str) -> Dict[str, Any]:
        ...
        try:
            if not PLAYWRIGHT_AVAILABLE:
                write_log("operator_backend", "browser:execute_js:playwright_not_available", level="WARNING")
    ...
    async def extract_text(self, url: str) -> str:
        ...
        try:
            if not PLAYWRIGHT_AVAILABLE:
                write_log("operator_backend", "browser:extract_text:playwright_not_available", level="WARNING")
                return ""
