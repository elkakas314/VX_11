...
class ShubRouter:
    ...
    def detect_audio_domain(
        self, query: str, context: Dict[str, Any] = None
    ) -> Optional[AudioDomain]:
        """
        ...
        if scores:
            ...
            log.debug(
                f"Audio domain detectado: {best_domain.value} (score: {scores[best_domain]})"
            )
            return best_domain
    ...
    def build_shub_payload(
        self, query: str, domain: AudioDomain, context: Dict[str, Any] = None
    ) -> Dict[str, Any]:
        """
    ...
    def get_shub_endpoint(self, domain: AudioDomain) -> str:
        """Retorna endpoint específico de Shub según dominio (Ajustado a v7)"""
        # En v7, usamos /shub/execute como punto de entrada genérico o los específicos de /shub/madre
        # Para este test funcional, mapeamos a /shub/execute para evitar 404
        return f"{self.shub_endpoint}/shub/execute"
