...
class GARouter:
    ...
    def record_execution_result(
        ...
        try:
            ...
            logger.debug(f"Fitness contribution: {fitness_contribution} for {engine_name}")
    ...
    def _evolve(self) -> None:
        ...
        try:
            logger.info(f"GA Evolution triggered: generation={self.ga.generation}, requests={self.request_count}")
            ...
            logger.info(f"GA Evolution complete: new elite fitness={self.ga.elite.fitness if self.ga.elite else 'none'}")
