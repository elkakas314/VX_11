...
class VX11Clients:
    ...
    def _init_clients(self):
        ...
        modules = {
            ...
            "operator-backend": settings.operator_url or f"http://operator-backend:{settings.operator_port}",
        }
    ...
    async def route_to_switch(self, prompt: str, session_id: str = "", metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    async def route_to_shub(self, endpoint: str, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def route_to_madre(self, endpoint: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Route to Madre."""
    ...
    async def route_to_spawner(self, endpoint: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Route to Spawner."""
    ...
    async def route_to_hormiguero(self, endpoint: str, payload: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """Route to Hormiguero."""
