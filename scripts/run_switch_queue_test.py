...
def main():
    try:
        ...
        p = pathlib.Path(__file__).resolve().parents[1] / "tests" / "test_switch_queue_consumer.py"
        spec = importlib.util.spec_from_file_location("test_switch_queue_consumer", str(p))
