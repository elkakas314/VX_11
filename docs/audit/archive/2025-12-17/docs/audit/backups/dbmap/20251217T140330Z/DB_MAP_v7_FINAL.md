...
**Generated:** 2025-12-17T11:09:49.391778Z
**Database:** data/runtime/vx11.db
**Total Tables:** 60

**Database Size:** 317.0MB

## System discovery (automatic scan)

**Scanned:** 2025-12-17T13:51:00Z (UTC)

### Canonical paths

- **Repository root:** /home/elkakas314/vx11
- **Database file:** data/runtime/vx11.db
- **Primary DB map:** docs/audit/DB_MAP_v7_FINAL.md
- **Audit folder:** docs/audit/
...
- Running containers (observed): vx11-tentaculo-link, vx11-switch, vx11-hermes
- Port health check (sample): 8000=ok, 8001=unavailable, 8002=ok, 8003=ok, 8005=down

### Checksums & DB metadata

- `vx11.db` SHA256: 1636a393af850cbb19ef60a353fa424a0562f7aca3a043f7599995f64018f9c1
- `DB_MAP_v7_FINAL.md` SHA256: 02fdc1e9937dc012b82f87308fc7b088bfd0910ffa8b8daf0ffe1c3114a045f2
- Database path: data/runtime/vx11.db (size: 353968128 bytes)
- Total tables (recorded): 60
- Total rows (summary): ~1,456,201

### Recommended metadata to keep in-map

- generated_at, scanner_id, db_path, db_sha256, db_size_bytes, total_tables, total_rows
- services_ports mapping, running_services snapshot, port_health summary
- canonical repo paths and important config files
- brief explanation: purpose of system, minimal runbook entries (how to check health endpoints)
...
2. [chat_providers_stats](#chat_providers_stats)
3. [cli_onboarding_state](#cli_onboarding_state)
4. [cli_providers](#cli_providers)
5. [cli_registry](#cli_registry)
6. [cli_usage_stats](#cli_usage_stats)
7. [context](#context)
8. [copilot_actions_log](#copilot_actions_log)
9. [copilot_repo_map](#copilot_repo_map)
10. [copilot_runtime_services](#copilot_runtime_services)
11. [copilot_workflows_catalog](#copilot_workflows_catalog)
12. [daughter_attempts](#daughter_attempts)
13. [daughter_tasks](#daughter_tasks)
14. [daughters](#daughters)
15. [drift_reports](#drift_reports)
16. [engines](#engines)
17. [events](#events)
18. [feromona_events](#feromona_events)
19. [fluzo_signals](#fluzo_signals)
20. [forensic_ledger](#forensic_ledger)
21. [hermes_ingest](#hermes_ingest)
22. [hijas_runtime](#hijas_runtime)
23. [hijas_state](#hijas_state)
24. [hormiga_state](#hormiga_state)
25. [ia_decisions](#ia_decisions)
26. [incidents](#incidents)
27. [intents_log](#intents_log)
28. [local_models_v2](#local_models_v2)
29. [madre_actions](#madre_actions)
30. [madre_policies](#madre_policies)
31. [model_registry](#model_registry)
32. [model_usage_stats](#model_usage_stats)
33. [models_local](#models_local)
34. [models_remote_cli](#models_remote_cli)
35. [module_health](#module_health)
36. [operator_browser_task](#operator_browser_task)
37. [operator_jobs](#operator_jobs)
38. [operator_message](#operator_message)
39. [operator_session](#operator_session)
40. [operator_switch_adjustment](#operator_switch_adjustment)
41. [operator_tool_call](#operator_tool_call)
42. [pheromone_log](#pheromone_log)
43. [power_events](#power_events)
44. [reports](#reports)
45. [routing_events](#routing_events)
46. [sandbox_exec](#sandbox_exec)
47. [scheduler_history](#scheduler_history)
48. [shub_analysis](#shub_analysis)
49. [shub_fx_chains](#shub_fx_chains)
50. [shub_presets](#shub_presets)
51. [shub_projects](#shub_projects)
52. [shub_tracks](#shub_tracks)
53. [spawns](#spawns)
54. [sqlite_sequence](#sqlite_sequence)
55. [switch_queue_v2](#switch_queue_v2)
56. [system_events](#system_events)
57. [system_state](#system_state)
58. [task_queue](#task_queue)
59. [tasks](#tasks)
60. [tokens_usage](#tokens_usage)
...
**Indices:** `sqlite_autoindex_chat_providers_stats_1`
...
|---|------|------|----|---------|---------|
| 0 | `provider` | TEXT | ✓ | ✓ |  |
| 1 | `success_count` | INTEGER |  | ✓ | 0 |
| 2 | `fail_count` | INTEGER |  | ✓ | 0 |
| 3 | `avg_latency_ms` | REAL |  | ✓ | 0 |

## cli_onboarding_state

**Rows:** 0

**Indices:** `sqlite_autoindex_cli_onboarding_state_1`
...
|---|------|------|----|---------|---------|
| 0 | `id` | INTEGER | ✓ |  |  |
| 1 | `provider_id` | VARCHAR(128) |  |  |  |
| 2 | `state` | VARCHAR(50) |  | ✓ |  |
| 3 | `notes` | TEXT |  | ✓ |  |
| 4 | `last_checked_at` | DATETIME |  | ✓ |  |
...
| 3 | `success` | BOOLEAN |  | ✓ |  |
| 4 | `latency_ms` | INTEGER |  | ✓ |  |
| 5 | `cost_estimated` | FLOAT |  | ✓ |  |
| 6 | `tokens_estimated` | INTEGER |  | ✓ |  |
| 7 | `error_class` | VARCHAR(100) |  | ✓ |  |
...
| 0 | `id` | INTEGER | ✓ | ✓ |  |
| 1 | `session_id` | TEXT |  | ✓ |  |
| 2 | `timestamp` | TIMESTAMP |  | ✓ | CURRENT_TIMESTAMP |
| 3 | `action` | TEXT |  | ✓ |  |
| 4 | `mode` | TEXT |  | ✓ |  |
| 5 | `files_touched` | INTEGER |  | ✓ | 0 |
| 6 | `git_commit` | TEXT |  | ✓ |  |
| 7 | `status` | TEXT |  | ✓ |  |
| 8 | `notes` | TEXT |  | ✓ |  |
...
**Indices:** `sqlite_autoindex_copilot_repo_map_1`
...
**Indices:** `sqlite_autoindex_copilot_runtime_services_1`
...
| 0 | `id` | INTEGER | ✓ | ✓ |  |
| 1 | `service_name` | TEXT |  | ✓ |  |
| 2 | `host` | TEXT |  | ✓ | 'localhost' |
| 3 | `port` | INTEGER |  | ✓ |  |
| 4 | `health_url` | TEXT |  | ✓ |  |
| 5 | `status` | TEXT |  | ✓ | 'unknown' |
| 6 | `last_check` | TIMESTAMP |  | ✓ |  |
| 7 | `created_at` | TIMESTAMP |  | ✓ | CURRENT_TIMESTAMP |
| 8 | `http_code` | INTEGER |  | ✓ |  |
| 9 | `latency_ms` | INTEGER |  | ✓ |  |
| 10 | `endpoint_ok` | TEXT |  | ✓ |  |
| 11 | `snippet` | TEXT |  | ✓ |  |
| 12 | `checked_at` | TIMESTAMP |  | ✓ |  |

## copilot_workflows_catalog

**Rows:** 0

**Indices:** `sqlite_autoindex_copilot_workflows_catalog_1`
...
| 3 | `mem_pct` | FLOAT |  | ✓ |  |
| 4 | `on_ac` | BOOLEAN |  | ✓ |  |
| 5 | `battery_pct` | INTEGER |  | ✓ |  |
| 6 | `profile` | VARCHAR(32) |  | ✓ |  |
...
| 0 | `id` | INTEGER | ✓ |  |  |
| 1 | `timestamp` | DATETIME |  | ✓ |  |
| 2 | `trace_id` | VARCHAR(36) |  |  |  |
| 3 | `route_type` | VARCHAR(50) |  |  |  |
| 4 | `provider_id` | VARCHAR(128) |  |  |  |
| 5 | `score` | FLOAT |  | ✓ |  |
| 6 | `reasoning_short` | VARCHAR(255) |  | ✓ |  |
