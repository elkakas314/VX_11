...
// reactflow is not available in this environment — provide a lightweight shim
// that supplies the minimal Handle component and Position constants used here.
const Handle: React.FC<any> = (_props) => <div />;
const Position = { Top: "top", Bottom: "bottom" } as const;
