...
describe('PHASE 5: Operator Endpoints - Comprehensive Test Suite', () => {
    ...
    // ========================================================================
    // TEST GROUP 1: /operator/api/events - Event Stream
    // ========================================================================

    describe('GET /operator/api/events - Event Stream', () => {
        it('should fetch events with default pagination', async () => {
            ...
            const response = await fetch(`${BASE_URL}/operator/api/events`, {
        ...
        it('should filter events by severity', async () => {
            ...
            const response = await fetch(`${BASE_URL}/operator/api/events?severity=critical`, {
                headers: { 'x-vx11-token': TOKEN },
            })
        ...
        it('should filter events by module', async () => {
            ...
            const response = await fetch(`${BASE_URL}/operator/api/events?module=manifestator`, {
                headers: { 'x-vx11-token': TOKEN },
            })
    ...
    // ========================================================================
    // TEST GROUP 2: /operator/api/metrics - Metrics Timeseries
    // ========================================================================

    describe('GET /operator/api/metrics - Metrics Timeseries', () => {
        it('should fetch metrics with time window', async () => {
            ...
            const response = await fetch(`${BASE_URL}/operator/api/metrics?window_seconds=3600`, {
                headers: { 'x-vx11-token': TOKEN },
            })
        ...
        it('should filter metrics by module', async () => {
            ...
            const response = await fetch(`${BASE_URL}/operator/api/metrics?module=redis`, {
                headers: { 'x-vx11-token': TOKEN },
            })
    ...
    // ========================================================================
    // TEST GROUP 3: /operator/api/rails - Manifestator Rails + Lanes
    // ========================================================================

    describe('GET /operator/api/rails/lanes - Manifestator Lanes', () => {
        it('should fetch all drift detection lanes', async () => {
            ...
            const response = await fetch(`${BASE_URL}/operator/api/rails/lanes`, {
                headers: { 'x-vx11-token': TOKEN },
            })
    ...
    describe('GET /operator/api/rails - Rails Constraints', () => {
        it('should fetch all active rails (constraints)', async () => {
            ...
            const response = await fetch(`${BASE_URL}/operator/api/rails`, {
                headers: { 'x-vx11-token': TOKEN },
            })
    ...
    describe('GET /operator/api/rails/{lane_id}/status - Lane Detail', () => {
        it('should fetch detailed lane status with audit findings', async () => {
            ...
            const response = await fetch(`${BASE_URL}/operator/api/rails/lane_001_detect/status`, {
                headers: { 'x-vx11-token': TOKEN },
            })
        ...
        it('should return 404 for non-existent lane', async () => {
            ...
            const response = await fetch(`${BASE_URL}/operator/api/rails/lane_nonexistent/status`, {
                headers: { 'x-vx11-token': TOKEN },
            })
    ...
    describe('Window Lifecycle - solo_madre ↔ window_active', () => {
        it('should show degraded status when operator backend is OFF', async () => {
            ...
            const response = await fetch(`${BASE_URL}/operator/api/chat/window/status`, {
                headers: { 'x-vx11-token': TOKEN },
            })
    ...
    describe('Correlation ID Tracking', () => {
        ...
        it('should trace request chain via correlation_id', async () => {
            ...
            const response = await fetch(`${BASE_URL}/operator/api/events?correlation_id=corr_chain_test`, {
                headers: { 'x-vx11-token': TOKEN },
            })
    ...
    describe('Error Handling & Graceful Degradation', () => {
        ...
        it('should handle network timeout gracefully', async () => {
            ...
            try {
                await fetch(`${BASE_URL}/operator/api/events`, {
                    headers: { 'x-vx11-token': TOKEN },
                })
            } catch (err) {
